...
data.scales = {
  guided: {
    scales: [
      ...
      { label: "5. Bub", value: "nebula_scales/tenor/Circular 5th Minor - G3 to C5 - Tenor.mp3" },
      ...
      { label: "8. Tenor Passagio (Nnng-Ayy)", value: "nebula_scales/tenor/Circular 9th Minor - F3 to C5 - Tenor.mp3" },
