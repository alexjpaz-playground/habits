...
data.scales = {
  guided: {
    scales: [
      ...
      { label: "6. Gug", value: "nebula_scales/baritone/Standard Octave Chromatic - G2 to G4 - Baritone.mp3" },
      { label: "7. Goo/Koo", value: "nebula_scales/tenor/Standard 9th Major - C3 to C5 - Tenor.mp3" },
      { label: "8. Siren Baritone", value: "nebula_scales/baritone/Siren Octave Major - G2 to G4 - Baritone.mp3" },
